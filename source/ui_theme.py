...
# Win Design System 1.0 opaque surfaces. Tk cannot reproduce Mica or Acrylic
# reliably, so hierarchy comes from restrained contrast and spacing instead.
_LIGHT = {
    "surface": "#F3F3F3",
    "surface_alt": "#FFFFFF",
...
# Opaque dark surfaces keep classic Tk predictable on Windows and Linux.
_DARK = {
    "surface": "#202020",
    "surface_alt": "#2B2B2B",
